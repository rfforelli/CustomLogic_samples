...
// ==============================================================
#ifndef __pix_average_sum_V_0_H__
#define __pix_average_sum_V_0_H__
...
struct pix_average_sum_V_0_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(pix_average_sum_V_0_ram) {
...
pix_average_sum_V_0_ram* meminst;


SC_CTOR(pix_average_sum_V_0) {
meminst = new pix_average_sum_V_0_ram("pix_average_sum_V_0_ram");
