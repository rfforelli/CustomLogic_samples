...
(* CORE_GENERATION_INFO="myproject_axi,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcku035-fbva676-2-e,HLS_INPUT_CLOCK=2.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.575250,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=150,HLS_SYN_DSP=0,HLS_SYN_FF=2265,HLS_SYN_LUT=4411,HLS_VERSION=2018_3}" *)
...
wire   [127:0] grp_myproject_fu_302_VideoOut_TDATA;
wire   [3:0] grp_myproject_fu_302_VideoOut_TUSER;
wire    grp_myproject_fu_302_VideoIn_TVALID;
wire    grp_myproject_fu_302_VideoIn_TREADY;
wire    grp_myproject_fu_302_ap_start;
wire    grp_myproject_fu_302_VideoOut_TVALID;
wire    grp_myproject_fu_302_VideoOut_TREADY;
wire    grp_myproject_fu_302_ap_done;
wire    grp_myproject_fu_302_ap_ready;
wire    grp_myproject_fu_302_ap_idle;
reg    grp_myproject_fu_302_ap_continue;
reg    grp_myproject_fu_302_ap_start_reg;
reg    ap_block_state2_ignore_call65;
wire    ap_CS_fsm_state3;
wire    ap_sync_grp_myproject_fu_302_ap_ready;
wire    ap_sync_grp_myproject_fu_302_ap_done;
reg    ap_block_state3_on_subcall_done;
reg    ap_sync_reg_grp_myproject_fu_302_ap_ready;
reg    ap_sync_reg_grp_myproject_fu_302_ap_done;
reg    ap_block_state2;
...
#0 grp_myproject_fu_302_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_myproject_fu_302_ap_ready = 1'b0;
#0 ap_sync_reg_grp_myproject_fu_302_ap_done = 1'b0;
...
myproject grp_myproject_fu_302(
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_myproject_fu_302_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state3_on_subcall_done) & (1'b1 == ap_CS_fsm_state3))) begin
            ap_sync_reg_grp_myproject_fu_302_ap_done <= 1'b0;
        end else if ((grp_myproject_fu_302_ap_done == 1'b1)) begin
            ap_sync_reg_grp_myproject_fu_302_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_myproject_fu_302_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state3_on_subcall_done) & (1'b1 == ap_CS_fsm_state3))) begin
            ap_sync_reg_grp_myproject_fu_302_ap_ready <= 1'b0;
        end else if ((grp_myproject_fu_302_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_myproject_fu_302_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_myproject_fu_302_ap_start_reg <= 1'b0;
    end else begin
        if ((((ap_sync_grp_myproject_fu_302_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state3)) | (~((1'b0 == MetaIn_Status_ap_vld_preg) | (1'b0 == MetaIn_ModPixelF_ap_vld_preg) | (1'b0 == MetaIn_PixProcessingFlgs_ap_vld_preg) | (1'b0 == MetaIn_Timestamp_ap_vld_preg) | (1'b0 == MetaIn_Flags_ap_vld_preg) | (1'b0 == MetaIn_TapG_ap_vld_preg) | (1'b0 == MetaIn_PixelF_ap_vld_preg) | (1'b0 == MetaIn_DsizeL_V_ap_vld_preg) | (1'b0 == MetaIn_Yoffs_V_ap_vld_preg) | (1'b0 == MetaIn_Ysize_V_ap_vld_preg) | (1'b0 == MetaIn_Xoffs_V_ap_vld_preg) | (1'b0 == MetaIn_Xsize_V_ap_vld_preg) | (1'b0 == MetaIn_SourceTag_ap_vld_preg) | (1'b0 == MetaIn_StreamId_ap_vld_preg)) & (1'b1 == ap_CS_fsm_state2)))) begin
            grp_myproject_fu_302_ap_start_reg <= 1'b1;
        end else if ((grp_myproject_fu_302_ap_ready == 1'b1)) begin
            grp_myproject_fu_302_ap_start_reg <= 1'b0;
        end
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_state3_on_subcall_done) & (1'b1 == ap_CS_fsm_state3))) begin
        grp_myproject_fu_302_ap_continue = 1'b1;
    end else begin
        grp_myproject_fu_302_ap_continue = 1'b0;
    end
end
...
assign VideoOut_V_Data_V_1_vld_in = grp_myproject_fu_302_VideoOut_TVALID;
...
assign VideoOut_V_User_V_1_vld_in = grp_myproject_fu_302_VideoOut_TVALID;
...
always @ (*) begin
    ap_block_state3_on_subcall_done = ((ap_sync_grp_myproject_fu_302_ap_ready & ap_sync_grp_myproject_fu_302_ap_done) == 1'b0);
end
...
assign ap_sync_grp_myproject_fu_302_ap_done = (grp_myproject_fu_302_ap_done | ap_sync_reg_grp_myproject_fu_302_ap_done);

assign ap_sync_grp_myproject_fu_302_ap_ready = (grp_myproject_fu_302_ap_ready | ap_sync_reg_grp_myproject_fu_302_ap_ready);

assign grp_myproject_fu_302_VideoIn_TVALID = VideoIn_V_User_V_0_state[1'd0];

assign grp_myproject_fu_302_VideoOut_TREADY = ((ap_CS_fsm_state3 & VideoOut_V_User_V_1_ack_in) | (ap_CS_fsm_state3 & VideoOut_V_Data_V_1_ack_in));

assign grp_myproject_fu_302_ap_start = grp_myproject_fu_302_ap_start_reg;
