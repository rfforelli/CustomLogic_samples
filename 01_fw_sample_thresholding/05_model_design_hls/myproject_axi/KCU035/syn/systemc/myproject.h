...
#include "start_for_pix_threshold_U0.h"
...
struct myproject : public sc_module {
    ...
    sc_signal< sc_logic > pix_threshold_U0_ap_start;
    sc_signal< sc_logic > pix_threshold_U0_ap_done;
    sc_signal< sc_logic > pix_threshold_U0_ap_continue;
    sc_signal< sc_logic > pix_threshold_U0_ap_idle;
    sc_signal< sc_logic > pix_threshold_U0_ap_ready;
    sc_signal< sc_logic > pix_threshold_U0_start_out;
    sc_signal< sc_logic > pix_threshold_U0_start_write;
    sc_signal< sc_logic > pix_threshold_U0_StreamIn_V_Data_V_read;
    sc_signal< sc_logic > pix_threshold_U0_StreamIn_V_User_V_read;
    sc_signal< sc_lv<128> > pix_threshold_U0_StreamOut_V_Data_V_din;
    sc_signal< sc_logic > pix_threshold_U0_StreamOut_V_Data_V_write;
    sc_signal< sc_lv<4> > pix_threshold_U0_StreamOut_V_User_V_din;
    sc_signal< sc_logic > pix_threshold_U0_StreamOut_V_User_V_write;
    ...
    sc_signal< sc_logic > ThresholdOut_V_Data_s_full_n;
    sc_signal< sc_lv<128> > ThresholdOut_V_Data_s_dout;
    sc_signal< sc_logic > ThresholdOut_V_Data_s_empty_n;
    sc_signal< sc_logic > ThresholdOut_V_User_s_full_n;
    sc_signal< sc_lv<4> > ThresholdOut_V_User_s_dout;
    sc_signal< sc_logic > ThresholdOut_V_User_s_empty_n;
    sc_signal< sc_logic > ap_sync_done;
    sc_signal< sc_logic > ap_sync_ready;
    sc_signal< sc_lv<1> > start_for_pix_threshold_U0_din;
    sc_signal< sc_logic > start_for_pix_threshold_U0_full_n;
    sc_signal< sc_lv<1> > start_for_pix_threshold_U0_dout;
    sc_signal< sc_logic > start_for_pix_threshold_U0_empty_n;
    ...
    void thread_pix_threshold_U0_ap_continue();
    void thread_pix_threshold_U0_ap_start();
    ...
    void thread_start_for_pix_threshold_U0_din();
