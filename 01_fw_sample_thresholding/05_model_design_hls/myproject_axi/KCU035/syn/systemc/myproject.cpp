...
myproject::myproject(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    read_pixel_data_U0->start_full_n(start_for_pix_threshold_U0_full_n);
    ...
    pix_threshold_U0 = new pix_threshold("pix_threshold_U0");
    pix_threshold_U0->ap_clk(ap_clk);
    pix_threshold_U0->ap_rst(ap_rst);
    pix_threshold_U0->ap_start(pix_threshold_U0_ap_start);
    pix_threshold_U0->start_full_n(start_for_send_output_U0_full_n);
    pix_threshold_U0->ap_done(pix_threshold_U0_ap_done);
    pix_threshold_U0->ap_continue(pix_threshold_U0_ap_continue);
    pix_threshold_U0->ap_idle(pix_threshold_U0_ap_idle);
    pix_threshold_U0->ap_ready(pix_threshold_U0_ap_ready);
    pix_threshold_U0->start_out(pix_threshold_U0_start_out);
    pix_threshold_U0->start_write(pix_threshold_U0_start_write);
    pix_threshold_U0->StreamIn_V_Data_V_dout(VideoBuffer_V_Data_V_dout);
    pix_threshold_U0->StreamIn_V_Data_V_empty_n(VideoBuffer_V_Data_V_empty_n);
    pix_threshold_U0->StreamIn_V_Data_V_read(pix_threshold_U0_StreamIn_V_Data_V_read);
    pix_threshold_U0->StreamIn_V_User_V_dout(VideoBuffer_V_User_V_dout);
    pix_threshold_U0->StreamIn_V_User_V_empty_n(VideoBuffer_V_User_V_empty_n);
    pix_threshold_U0->StreamIn_V_User_V_read(pix_threshold_U0_StreamIn_V_User_V_read);
    pix_threshold_U0->StreamOut_V_Data_V_din(pix_threshold_U0_StreamOut_V_Data_V_din);
    pix_threshold_U0->StreamOut_V_Data_V_full_n(ThresholdOut_V_Data_s_full_n);
    pix_threshold_U0->StreamOut_V_Data_V_write(pix_threshold_U0_StreamOut_V_Data_V_write);
    pix_threshold_U0->StreamOut_V_User_V_din(pix_threshold_U0_StreamOut_V_User_V_din);
    pix_threshold_U0->StreamOut_V_User_V_full_n(ThresholdOut_V_User_s_full_n);
    pix_threshold_U0->StreamOut_V_User_V_write(pix_threshold_U0_StreamOut_V_User_V_write);
    ...
    send_output_U0->StreamIn_V_Data_V_dout(ThresholdOut_V_Data_s_dout);
    send_output_U0->StreamIn_V_Data_V_empty_n(ThresholdOut_V_Data_s_empty_n);
    send_output_U0->StreamIn_V_Data_V_read(send_output_U0_StreamIn_V_Data_V_read);
    send_output_U0->StreamIn_V_User_V_dout(ThresholdOut_V_User_s_dout);
    send_output_U0->StreamIn_V_User_V_empty_n(ThresholdOut_V_User_s_empty_n);
    ...
    VideoBuffer_V_Data_V_U->if_read(pix_threshold_U0_StreamIn_V_Data_V_read);
    ...
    VideoBuffer_V_User_V_U->if_read(pix_threshold_U0_StreamIn_V_User_V_read);
    ThresholdOut_V_Data_s_U = new fifo_w128_d10240_A("ThresholdOut_V_Data_s_U");
    ThresholdOut_V_Data_s_U->clk(ap_clk);
    ThresholdOut_V_Data_s_U->reset(ap_rst);
    ThresholdOut_V_Data_s_U->if_read_ce(ap_var_for_const0);
    ThresholdOut_V_Data_s_U->if_write_ce(ap_var_for_const0);
    ThresholdOut_V_Data_s_U->if_din(pix_threshold_U0_StreamOut_V_Data_V_din);
    ThresholdOut_V_Data_s_U->if_full_n(ThresholdOut_V_Data_s_full_n);
    ThresholdOut_V_Data_s_U->if_write(pix_threshold_U0_StreamOut_V_Data_V_write);
    ThresholdOut_V_Data_s_U->if_dout(ThresholdOut_V_Data_s_dout);
    ThresholdOut_V_Data_s_U->if_empty_n(ThresholdOut_V_Data_s_empty_n);
    ThresholdOut_V_Data_s_U->if_read(send_output_U0_StreamIn_V_Data_V_read);
    ThresholdOut_V_User_s_U = new fifo_w4_d10240_A("ThresholdOut_V_User_s_U");
    ThresholdOut_V_User_s_U->clk(ap_clk);
    ThresholdOut_V_User_s_U->reset(ap_rst);
    ThresholdOut_V_User_s_U->if_read_ce(ap_var_for_const0);
    ThresholdOut_V_User_s_U->if_write_ce(ap_var_for_const0);
    ThresholdOut_V_User_s_U->if_din(pix_threshold_U0_StreamOut_V_User_V_din);
    ThresholdOut_V_User_s_U->if_full_n(ThresholdOut_V_User_s_full_n);
    ThresholdOut_V_User_s_U->if_write(pix_threshold_U0_StreamOut_V_User_V_write);
    ThresholdOut_V_User_s_U->if_dout(ThresholdOut_V_User_s_dout);
    ThresholdOut_V_User_s_U->if_empty_n(ThresholdOut_V_User_s_empty_n);
    ThresholdOut_V_User_s_U->if_read(send_output_U0_StreamIn_V_User_V_read);
    start_for_pix_threshold_U0_U = new start_for_pix_threshold_U0("start_for_pix_threshold_U0_U");
    start_for_pix_threshold_U0_U->clk(ap_clk);
    start_for_pix_threshold_U0_U->reset(ap_rst);
    start_for_pix_threshold_U0_U->if_read_ce(ap_var_for_const0);
    start_for_pix_threshold_U0_U->if_write_ce(ap_var_for_const0);
    start_for_pix_threshold_U0_U->if_din(start_for_pix_threshold_U0_din);
    start_for_pix_threshold_U0_U->if_full_n(start_for_pix_threshold_U0_full_n);
    start_for_pix_threshold_U0_U->if_write(read_pixel_data_U0_start_write);
    start_for_pix_threshold_U0_U->if_dout(start_for_pix_threshold_U0_dout);
    start_for_pix_threshold_U0_U->if_empty_n(start_for_pix_threshold_U0_empty_n);
    start_for_pix_threshold_U0_U->if_read(pix_threshold_U0_ap_ready);
    ...
    start_for_send_output_U0_U->if_write(pix_threshold_U0_start_write);
    ...
    sensitive << ( pix_threshold_U0_ap_idle );
    ...
    SC_METHOD(thread_pix_threshold_U0_ap_continue);

    SC_METHOD(thread_pix_threshold_U0_ap_start);
    sensitive << ( start_for_pix_threshold_U0_empty_n );
    ...
    SC_METHOD(thread_start_for_pix_threshold_U0_din);
    ...
    sc_trace(mVcdFile, pix_threshold_U0_ap_start, "pix_threshold_U0_ap_start");
    sc_trace(mVcdFile, pix_threshold_U0_ap_done, "pix_threshold_U0_ap_done");
    sc_trace(mVcdFile, pix_threshold_U0_ap_continue, "pix_threshold_U0_ap_continue");
    sc_trace(mVcdFile, pix_threshold_U0_ap_idle, "pix_threshold_U0_ap_idle");
    sc_trace(mVcdFile, pix_threshold_U0_ap_ready, "pix_threshold_U0_ap_ready");
    sc_trace(mVcdFile, pix_threshold_U0_start_out, "pix_threshold_U0_start_out");
    sc_trace(mVcdFile, pix_threshold_U0_start_write, "pix_threshold_U0_start_write");
    sc_trace(mVcdFile, pix_threshold_U0_StreamIn_V_Data_V_read, "pix_threshold_U0_StreamIn_V_Data_V_read");
    sc_trace(mVcdFile, pix_threshold_U0_StreamIn_V_User_V_read, "pix_threshold_U0_StreamIn_V_User_V_read");
    sc_trace(mVcdFile, pix_threshold_U0_StreamOut_V_Data_V_din, "pix_threshold_U0_StreamOut_V_Data_V_din");
    sc_trace(mVcdFile, pix_threshold_U0_StreamOut_V_Data_V_write, "pix_threshold_U0_StreamOut_V_Data_V_write");
    sc_trace(mVcdFile, pix_threshold_U0_StreamOut_V_User_V_din, "pix_threshold_U0_StreamOut_V_User_V_din");
    sc_trace(mVcdFile, pix_threshold_U0_StreamOut_V_User_V_write, "pix_threshold_U0_StreamOut_V_User_V_write");
    ...
    sc_trace(mVcdFile, ThresholdOut_V_Data_s_full_n, "ThresholdOut_V_Data_s_full_n");
    sc_trace(mVcdFile, ThresholdOut_V_Data_s_dout, "ThresholdOut_V_Data_s_dout");
    sc_trace(mVcdFile, ThresholdOut_V_Data_s_empty_n, "ThresholdOut_V_Data_s_empty_n");
    sc_trace(mVcdFile, ThresholdOut_V_User_s_full_n, "ThresholdOut_V_User_s_full_n");
    sc_trace(mVcdFile, ThresholdOut_V_User_s_dout, "ThresholdOut_V_User_s_dout");
    sc_trace(mVcdFile, ThresholdOut_V_User_s_empty_n, "ThresholdOut_V_User_s_empty_n");
    sc_trace(mVcdFile, ap_sync_done, "ap_sync_done");
    sc_trace(mVcdFile, ap_sync_ready, "ap_sync_ready");
    sc_trace(mVcdFile, start_for_pix_threshold_U0_din, "start_for_pix_threshold_U0_din");
    sc_trace(mVcdFile, start_for_pix_threshold_U0_full_n, "start_for_pix_threshold_U0_full_n");
    sc_trace(mVcdFile, start_for_pix_threshold_U0_dout, "start_for_pix_threshold_U0_dout");
    sc_trace(mVcdFile, start_for_pix_threshold_U0_empty_n, "start_for_pix_threshold_U0_empty_n");
...
myproject::~myproject() {
    ...
    delete pix_threshold_U0;
    delete send_output_U0;
    delete VideoBuffer_V_Data_V_U;
    delete VideoBuffer_V_User_V_U;
    delete ThresholdOut_V_Data_s_U;
    delete ThresholdOut_V_User_s_U;
    delete start_for_pix_threshold_U0_U;
...
void myproject::thread_ap_idle() {
    ap_idle = (read_pixel_data_U0_ap_idle.read() & pix_threshold_U0_ap_idle.read() & send_output_U0_ap_idle.read());
}
...
void myproject::thread_pix_threshold_U0_ap_continue() {
    pix_threshold_U0_ap_continue = ap_const_logic_1;
}

void myproject::thread_pix_threshold_U0_ap_start() {
    pix_threshold_U0_ap_start = start_for_pix_threshold_U0_empty_n.read();
}
...
void myproject::thread_start_for_pix_threshold_U0_din() {
    start_for_pix_threshold_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}
