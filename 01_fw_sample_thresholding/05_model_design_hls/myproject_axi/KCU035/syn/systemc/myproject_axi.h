...
struct myproject_axi : public sc_module {
    ...
    sc_signal< sc_lv<128> > grp_myproject_fu_302_VideoOut_TDATA;
    sc_signal< sc_lv<4> > grp_myproject_fu_302_VideoOut_TUSER;
    sc_signal< sc_logic > grp_myproject_fu_302_VideoIn_TVALID;
    sc_signal< sc_logic > grp_myproject_fu_302_VideoIn_TREADY;
    sc_signal< sc_logic > grp_myproject_fu_302_ap_start;
    sc_signal< sc_logic > grp_myproject_fu_302_VideoOut_TVALID;
    sc_signal< sc_logic > grp_myproject_fu_302_VideoOut_TREADY;
    sc_signal< sc_logic > grp_myproject_fu_302_ap_done;
    sc_signal< sc_logic > grp_myproject_fu_302_ap_ready;
    sc_signal< sc_logic > grp_myproject_fu_302_ap_idle;
    sc_signal< sc_logic > grp_myproject_fu_302_ap_continue;
    sc_signal< sc_logic > grp_myproject_fu_302_ap_start_reg;
    sc_signal< bool > ap_block_state2_ignore_call65;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_logic > ap_sync_grp_myproject_fu_302_ap_ready;
    sc_signal< sc_logic > ap_sync_grp_myproject_fu_302_ap_done;
    sc_signal< bool > ap_block_state3_on_subcall_done;
    sc_signal< sc_logic > ap_sync_reg_grp_myproject_fu_302_ap_ready;
    sc_signal< sc_logic > ap_sync_reg_grp_myproject_fu_302_ap_done;
    ...
    void thread_ap_sync_grp_myproject_fu_302_ap_done();
    void thread_ap_sync_grp_myproject_fu_302_ap_ready();
    void thread_grp_myproject_fu_302_VideoIn_TVALID();
    void thread_grp_myproject_fu_302_VideoOut_TREADY();
    void thread_grp_myproject_fu_302_ap_continue();
    void thread_grp_myproject_fu_302_ap_start();
