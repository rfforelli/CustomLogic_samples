...
# FIFO definition:
set ID 13
set FifoName fifo_w128_d10240_A
set InstName VideoBuffer_V_Data_V_U
...
# FIFO definition:
set ID 14
set FifoName fifo_w4_d10240_A
set InstName VideoBuffer_V_User_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 15
set FifoName fifo_w128_d10240_A
set InstName ThresholdOut_V_Data_s_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 16
set FifoName fifo_w4_d10240_A
set InstName ThresholdOut_V_User_s_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 17
set FifoName start_for_pix_threshold_U0
set InstName start_for_pix_threshold_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 18
set FifoName start_for_send_output_U0
set InstName start_for_send_output_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { VideoIn_TUSER { I 4 vector } VideoIn_TVALID { I 1 bit } VideoIn_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { VideoOut_TUSER { O 4 vector } VideoOut_TVALID { O 1 bit } VideoOut_TREADY { I 1 bit } } \
} "
} else {
