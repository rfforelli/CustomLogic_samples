...
void myproject_axi(hls::stream<video_if_t> &VideoIn, hls::stream<video_if_t> &VideoOut,
         Metadata_t* MetaIn, Metadata_t* MetaOut, ap_uint<STREAM_DATA_WIDTH>* onboard_mem_base, pixMono8 customlogic_reset) {
  ...
  myproject(VideoIn, VideoOut, onboard_mem_base, customlogic_reset);
