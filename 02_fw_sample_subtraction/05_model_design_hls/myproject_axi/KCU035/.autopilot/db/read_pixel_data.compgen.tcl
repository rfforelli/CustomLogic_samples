...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { VideoIn_TDATA { I 128 vector } VideoIn_TVALID { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'StreamIn_V_Data_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { VideoIn_TREADY { O 1 bit } VideoIn_TUSER { I 4 vector } } \
} "
} else {
