...
myproject_axi::myproject_axi(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_myproject_fu_320 = new myproject("grp_myproject_fu_320");
    grp_myproject_fu_320->VideoIn_TDATA(VideoIn_V_Data_V_0_data_out);
    grp_myproject_fu_320->VideoIn_TUSER(VideoIn_V_User_V_0_data_out);
    grp_myproject_fu_320->VideoOut_TDATA(grp_myproject_fu_320_VideoOut_TDATA);
    grp_myproject_fu_320->VideoOut_TUSER(grp_myproject_fu_320_VideoOut_TUSER);
    grp_myproject_fu_320->ap_clk(ap_clk);
    grp_myproject_fu_320->ap_rst(ap_rst_n_inv);
    grp_myproject_fu_320->VideoIn_TVALID(grp_myproject_fu_320_VideoIn_TVALID);
    grp_myproject_fu_320->VideoIn_TREADY(grp_myproject_fu_320_VideoIn_TREADY);
    grp_myproject_fu_320->ap_start(grp_myproject_fu_320_ap_start);
    grp_myproject_fu_320->VideoOut_TVALID(grp_myproject_fu_320_VideoOut_TVALID);
    grp_myproject_fu_320->VideoOut_TREADY(grp_myproject_fu_320_VideoOut_TREADY);
    grp_myproject_fu_320->ap_done(grp_myproject_fu_320_ap_done);
    grp_myproject_fu_320->ap_ready(grp_myproject_fu_320_ap_ready);
    grp_myproject_fu_320->ap_idle(grp_myproject_fu_320_ap_idle);
    grp_myproject_fu_320->ap_continue(grp_myproject_fu_320_ap_continue);
    ...
    sensitive << ( grp_myproject_fu_320_VideoIn_TREADY );
    ...
    sensitive << ( grp_myproject_fu_320_VideoOut_TVALID );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    sensitive << ( ap_sync_grp_myproject_fu_320_ap_ready );
    sensitive << ( ap_sync_grp_myproject_fu_320_ap_done );
    ...
    SC_METHOD(thread_ap_sync_grp_myproject_fu_320_ap_done);
    sensitive << ( grp_myproject_fu_320_ap_done );
    sensitive << ( ap_sync_reg_grp_myproject_fu_320_ap_done );

    SC_METHOD(thread_ap_sync_grp_myproject_fu_320_ap_ready);
    sensitive << ( grp_myproject_fu_320_ap_ready );
    sensitive << ( ap_sync_reg_grp_myproject_fu_320_ap_ready );

    SC_METHOD(thread_grp_myproject_fu_320_VideoIn_TVALID);
    sensitive << ( VideoIn_V_User_V_0_state );

    SC_METHOD(thread_grp_myproject_fu_320_VideoOut_TREADY);
    sensitive << ( VideoOut_V_Data_V_1_ack_in );
    sensitive << ( VideoOut_V_User_V_1_ack_in );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_grp_myproject_fu_320_ap_continue);
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_block_state3_on_subcall_done );

    SC_METHOD(thread_grp_myproject_fu_320_ap_start);
    sensitive << ( grp_myproject_fu_320_ap_start_reg );
    ...
    grp_myproject_fu_320_ap_start_reg = SC_LOGIC_0;
    ap_sync_reg_grp_myproject_fu_320_ap_ready = SC_LOGIC_0;
    ap_sync_reg_grp_myproject_fu_320_ap_done = SC_LOGIC_0;
    ...
    sc_trace(mVcdFile, grp_myproject_fu_320_VideoOut_TDATA, "grp_myproject_fu_320_VideoOut_TDATA");
    sc_trace(mVcdFile, grp_myproject_fu_320_VideoOut_TUSER, "grp_myproject_fu_320_VideoOut_TUSER");
    sc_trace(mVcdFile, grp_myproject_fu_320_VideoIn_TVALID, "grp_myproject_fu_320_VideoIn_TVALID");
    sc_trace(mVcdFile, grp_myproject_fu_320_VideoIn_TREADY, "grp_myproject_fu_320_VideoIn_TREADY");
    sc_trace(mVcdFile, grp_myproject_fu_320_ap_start, "grp_myproject_fu_320_ap_start");
    sc_trace(mVcdFile, grp_myproject_fu_320_VideoOut_TVALID, "grp_myproject_fu_320_VideoOut_TVALID");
    sc_trace(mVcdFile, grp_myproject_fu_320_VideoOut_TREADY, "grp_myproject_fu_320_VideoOut_TREADY");
    sc_trace(mVcdFile, grp_myproject_fu_320_ap_done, "grp_myproject_fu_320_ap_done");
    sc_trace(mVcdFile, grp_myproject_fu_320_ap_ready, "grp_myproject_fu_320_ap_ready");
    sc_trace(mVcdFile, grp_myproject_fu_320_ap_idle, "grp_myproject_fu_320_ap_idle");
    sc_trace(mVcdFile, grp_myproject_fu_320_ap_continue, "grp_myproject_fu_320_ap_continue");
    sc_trace(mVcdFile, grp_myproject_fu_320_ap_start_reg, "grp_myproject_fu_320_ap_start_reg");
    sc_trace(mVcdFile, ap_block_state2_ignore_call65, "ap_block_state2_ignore_call65");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, ap_sync_grp_myproject_fu_320_ap_ready, "ap_sync_grp_myproject_fu_320_ap_ready");
    sc_trace(mVcdFile, ap_sync_grp_myproject_fu_320_ap_done, "ap_sync_grp_myproject_fu_320_ap_done");
    sc_trace(mVcdFile, ap_block_state3_on_subcall_done, "ap_block_state3_on_subcall_done");
    sc_trace(mVcdFile, ap_sync_reg_grp_myproject_fu_320_ap_ready, "ap_sync_reg_grp_myproject_fu_320_ap_ready");
    sc_trace(mVcdFile, ap_sync_reg_grp_myproject_fu_320_ap_done, "ap_sync_reg_grp_myproject_fu_320_ap_done");
...
void myproject_axi::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ap_sync_reg_grp_myproject_fu_320_ap_done = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
             esl_seteq<1,1,1>(ap_block_state3_on_subcall_done.read(), ap_const_boolean_0))) {
            ap_sync_reg_grp_myproject_fu_320_ap_done = ap_const_logic_0;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_myproject_fu_320_ap_done.read())) {
            ap_sync_reg_grp_myproject_fu_320_ap_done = ap_const_logic_1;
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ap_sync_reg_grp_myproject_fu_320_ap_ready = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
             esl_seteq<1,1,1>(ap_block_state3_on_subcall_done.read(), ap_const_boolean_0))) {
            ap_sync_reg_grp_myproject_fu_320_ap_ready = ap_const_logic_0;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_myproject_fu_320_ap_ready.read())) {
            ap_sync_reg_grp_myproject_fu_320_ap_ready = ap_const_logic_1;
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        grp_myproject_fu_320_ap_start_reg = ap_const_logic_0;
    } else {
        if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
              !(esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_StreamId_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_SourceTag_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_Xsize_V_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_Xoffs_V_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_Ysize_V_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_Yoffs_V_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_DsizeL_V_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_PixelF_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_TapG_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_Flags_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_Timestamp_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_PixProcessingFlgs_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_ModPixelF_ap_vld_preg.read()) || esl_seteq<1,1,1>(ap_const_logic_0, MetaIn_Status_ap_vld_preg.read()))) || 
             (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
              esl_seteq<1,1,1>(ap_const_logic_0, ap_sync_grp_myproject_fu_320_ap_ready.read())))) {
            grp_myproject_fu_320_ap_start_reg = ap_const_logic_1;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_myproject_fu_320_ap_ready.read())) {
            grp_myproject_fu_320_ap_start_reg = ap_const_logic_0;
        }
    }
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, VideoOut_V_Data_V_1_load_A.read())) {
        VideoOut_V_Data_V_1_payload_A = grp_myproject_fu_320_VideoOut_TDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, VideoOut_V_Data_V_1_load_B.read())) {
        VideoOut_V_Data_V_1_payload_B = grp_myproject_fu_320_VideoOut_TDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, VideoOut_V_User_V_1_load_A.read())) {
        VideoOut_V_User_V_1_payload_A = grp_myproject_fu_320_VideoOut_TUSER.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, VideoOut_V_User_V_1_load_B.read())) {
        VideoOut_V_User_V_1_payload_B = grp_myproject_fu_320_VideoOut_TUSER.read();
    }
}
...
void myproject_axi::thread_VideoIn_V_Data_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        VideoIn_V_Data_V_0_ack_out = grp_myproject_fu_320_VideoIn_TREADY.read();
    } else {
...
void myproject_axi::thread_VideoIn_V_User_V_0_ack_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        VideoIn_V_User_V_0_ack_out = grp_myproject_fu_320_VideoIn_TREADY.read();
    } else {
...
void myproject_axi::thread_VideoOut_V_Data_V_1_vld_in() {
    VideoOut_V_Data_V_1_vld_in = grp_myproject_fu_320_VideoOut_TVALID.read();
}
...
void myproject_axi::thread_VideoOut_V_User_V_1_vld_in() {
    VideoOut_V_User_V_1_vld_in = grp_myproject_fu_320_VideoOut_TVALID.read();
}
...
void myproject_axi::thread_ap_block_state3_on_subcall_done() {
    ap_block_state3_on_subcall_done = esl_seteq<1,1,1>(ap_const_logic_0, (ap_sync_grp_myproject_fu_320_ap_ready.read() & ap_sync_grp_myproject_fu_320_ap_done.read()));
}
...
void myproject_axi::thread_ap_sync_grp_myproject_fu_320_ap_done() {
    ap_sync_grp_myproject_fu_320_ap_done = (grp_myproject_fu_320_ap_done.read() | ap_sync_reg_grp_myproject_fu_320_ap_done.read());
}

void myproject_axi::thread_ap_sync_grp_myproject_fu_320_ap_ready() {
    ap_sync_grp_myproject_fu_320_ap_ready = (grp_myproject_fu_320_ap_ready.read() | ap_sync_reg_grp_myproject_fu_320_ap_ready.read());
}

void myproject_axi::thread_grp_myproject_fu_320_VideoIn_TVALID() {
    grp_myproject_fu_320_VideoIn_TVALID = VideoIn_V_User_V_0_state.read()[0];
}

void myproject_axi::thread_grp_myproject_fu_320_VideoOut_TREADY() {
    grp_myproject_fu_320_VideoOut_TREADY = ((VideoOut_V_Data_V_1_ack_in.read() & 
  ap_CS_fsm_state3.read()) | (VideoOut_V_User_V_1_ack_in.read() & 
  ap_CS_fsm_state3.read()));
}

void myproject_axi::thread_grp_myproject_fu_320_ap_continue() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(ap_block_state3_on_subcall_done.read(), ap_const_boolean_0))) {
        grp_myproject_fu_320_ap_continue = ap_const_logic_1;
    } else {
        grp_myproject_fu_320_ap_continue = ap_const_logic_0;
    }
}

void myproject_axi::thread_grp_myproject_fu_320_ap_start() {
    grp_myproject_fu_320_ap_start = grp_myproject_fu_320_ap_start_reg.read();
}
