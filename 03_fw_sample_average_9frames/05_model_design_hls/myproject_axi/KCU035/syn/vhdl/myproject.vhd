...
architecture behav of myproject is 
    ...
    signal pix_average_U0_ap_start : STD_LOGIC;
    signal pix_average_U0_ap_done : STD_LOGIC;
    signal pix_average_U0_ap_continue : STD_LOGIC;
    signal pix_average_U0_ap_idle : STD_LOGIC;
    signal pix_average_U0_ap_ready : STD_LOGIC;
    signal pix_average_U0_start_out : STD_LOGIC;
    signal pix_average_U0_start_write : STD_LOGIC;
    signal pix_average_U0_StreamIn_V_Data_V_read : STD_LOGIC;
    signal pix_average_U0_StreamIn_V_User_V_read : STD_LOGIC;
    signal pix_average_U0_StreamOut_V_Data_V_din : STD_LOGIC_VECTOR (127 downto 0);
    signal pix_average_U0_StreamOut_V_Data_V_write : STD_LOGIC;
    signal pix_average_U0_StreamOut_V_User_V_din : STD_LOGIC_VECTOR (3 downto 0);
    signal pix_average_U0_StreamOut_V_User_V_write : STD_LOGIC;
    ...
    signal AveragedOut_V_Data_V_full_n : STD_LOGIC;
    signal AveragedOut_V_Data_V_dout : STD_LOGIC_VECTOR (127 downto 0);
    signal AveragedOut_V_Data_V_empty_n : STD_LOGIC;
    signal AveragedOut_V_User_V_full_n : STD_LOGIC;
    signal AveragedOut_V_User_V_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal AveragedOut_V_User_V_empty_n : STD_LOGIC;
    signal ap_sync_done : STD_LOGIC;
    signal ap_sync_ready : STD_LOGIC;
    signal start_for_pix_average_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_pix_average_U0_full_n : STD_LOGIC;
    signal start_for_pix_average_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_pix_average_U0_empty_n : STD_LOGIC;
    ...
    component start_for_pix_average_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        start_full_n => start_for_pix_average_U0_full_n,
    ...
    pix_average_U0 : component pix_average
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => pix_average_U0_ap_start,
        start_full_n => start_for_send_output_U0_full_n,
        ap_done => pix_average_U0_ap_done,
        ap_continue => pix_average_U0_ap_continue,
        ap_idle => pix_average_U0_ap_idle,
        ap_ready => pix_average_U0_ap_ready,
        start_out => pix_average_U0_start_out,
        start_write => pix_average_U0_start_write,
        StreamIn_V_Data_V_dout => VideoBuffer_V_Data_V_dout,
        StreamIn_V_Data_V_empty_n => VideoBuffer_V_Data_V_empty_n,
        StreamIn_V_Data_V_read => pix_average_U0_StreamIn_V_Data_V_read,
        StreamIn_V_User_V_dout => VideoBuffer_V_User_V_dout,
        StreamIn_V_User_V_empty_n => VideoBuffer_V_User_V_empty_n,
        StreamIn_V_User_V_read => pix_average_U0_StreamIn_V_User_V_read,
        StreamOut_V_Data_V_din => pix_average_U0_StreamOut_V_Data_V_din,
        StreamOut_V_Data_V_full_n => AveragedOut_V_Data_V_full_n,
        StreamOut_V_Data_V_write => pix_average_U0_StreamOut_V_Data_V_write,
        StreamOut_V_User_V_din => pix_average_U0_StreamOut_V_User_V_din,
        StreamOut_V_User_V_full_n => AveragedOut_V_User_V_full_n,
        StreamOut_V_User_V_write => pix_average_U0_StreamOut_V_User_V_write);
    ...
    port map (
        ...
        StreamIn_V_Data_V_dout => AveragedOut_V_Data_V_dout,
        StreamIn_V_Data_V_empty_n => AveragedOut_V_Data_V_empty_n,
        StreamIn_V_Data_V_read => send_output_U0_StreamIn_V_Data_V_read,
        StreamIn_V_User_V_dout => AveragedOut_V_User_V_dout,
        StreamIn_V_User_V_empty_n => AveragedOut_V_User_V_empty_n,
    ...
    port map (
        ...
        if_read => pix_average_U0_StreamIn_V_Data_V_read);
    ...
    port map (
        ...
        if_read => pix_average_U0_StreamIn_V_User_V_read);

    AveragedOut_V_Data_V_U : component fifo_w128_d10240_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => pix_average_U0_StreamOut_V_Data_V_din,
        if_full_n => AveragedOut_V_Data_V_full_n,
        if_write => pix_average_U0_StreamOut_V_Data_V_write,
        if_dout => AveragedOut_V_Data_V_dout,
        if_empty_n => AveragedOut_V_Data_V_empty_n,
        if_read => send_output_U0_StreamIn_V_Data_V_read);

    AveragedOut_V_User_V_U : component fifo_w4_d10240_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => pix_average_U0_StreamOut_V_User_V_din,
        if_full_n => AveragedOut_V_User_V_full_n,
        if_write => pix_average_U0_StreamOut_V_User_V_write,
        if_dout => AveragedOut_V_User_V_dout,
        if_empty_n => AveragedOut_V_User_V_empty_n,
        if_read => send_output_U0_StreamIn_V_User_V_read);

    start_for_pix_average_U0_U : component start_for_pix_average_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_pix_average_U0_din,
        if_full_n => start_for_pix_average_U0_full_n,
        if_write => read_pixel_data_U0_start_write,
        if_dout => start_for_pix_average_U0_dout,
        if_empty_n => start_for_pix_average_U0_empty_n,
        if_read => pix_average_U0_ap_ready);
    ...
    port map (
        ...
        if_write => pix_average_U0_start_write,
    ...
    VideoOut_TVALID <= send_output_U0_VideoOut_TVALID;
    ap_done <= send_output_U0_ap_done;
    ap_idle <= (send_output_U0_ap_idle and read_pixel_data_U0_ap_idle and pix_average_U0_ap_idle);
    ap_ready <= read_pixel_data_U0_ap_ready;
    ...
    pix_average_U0_ap_start <= start_for_pix_average_U0_empty_n;
    ...
    start_for_pix_average_U0_din <= (0=>ap_const_logic_1, others=>'-');
