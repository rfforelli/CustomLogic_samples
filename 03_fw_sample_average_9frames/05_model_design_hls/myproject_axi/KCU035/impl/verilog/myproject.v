...
wire    pix_average_U0_ap_start;
wire    pix_average_U0_ap_done;
wire    pix_average_U0_ap_continue;
wire    pix_average_U0_ap_idle;
wire    pix_average_U0_ap_ready;
wire    pix_average_U0_start_out;
wire    pix_average_U0_start_write;
wire    pix_average_U0_StreamIn_V_Data_V_read;
wire    pix_average_U0_StreamIn_V_User_V_read;
wire   [127:0] pix_average_U0_StreamOut_V_Data_V_din;
wire    pix_average_U0_StreamOut_V_Data_V_write;
wire   [3:0] pix_average_U0_StreamOut_V_User_V_din;
wire    pix_average_U0_StreamOut_V_User_V_write;
...
wire    AveragedOut_V_Data_V_full_n;
wire   [127:0] AveragedOut_V_Data_V_dout;
wire    AveragedOut_V_Data_V_empty_n;
wire    AveragedOut_V_User_V_full_n;
wire   [3:0] AveragedOut_V_User_V_dout;
wire    AveragedOut_V_User_V_empty_n;
wire    ap_sync_done;
wire    ap_sync_ready;
wire   [0:0] start_for_pix_average_U0_din;
wire    start_for_pix_average_U0_full_n;
wire   [0:0] start_for_pix_average_U0_dout;
wire    start_for_pix_average_U0_empty_n;
...
fifo_w128_d10240_A AveragedOut_V_Data_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w4_d10240_A AveragedOut_V_User_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_pix_average_U0 start_for_pix_average_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (send_output_U0_ap_idle & read_pixel_data_U0_ap_idle & pix_average_U0_ap_idle);
...
assign pix_average_U0_ap_continue = 1'b1;

assign pix_average_U0_ap_start = start_for_pix_average_U0_empty_n;
...
assign start_for_pix_average_U0_din = 1'b1;
